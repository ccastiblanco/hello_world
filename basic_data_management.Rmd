...
colnames(leadership)
# tambien podemos utilizar la función colnames - en este tendriamos que colocar todas las columnas
...
# Se puede colocar el nombre de cada columna sin asignación, pero deben ir en el mismo orden
