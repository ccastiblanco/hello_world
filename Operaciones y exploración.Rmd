...
resultado_suma <- +x+y
# Resultado sumó cada valor del vector por la variable!!
...
# le colocó negativo a cada elemento del vector  
...
#Con vectores de diferente tamaño, empieza de nuevo con los valores, para ir sumando
x1 <- c(1, 2, 4, 7, 9, 0, 8, 1)
resultado_suma_difvectores <- +x1 +z
resultado_igual_difvectores <- +x1 == z
resultado_igual_difvectores
# --------------------------- #
...
```
dplyr::filter(flights,  carrier == "B6" & distance <= 1500)
```
...
View(dplyr::filter(flights, carrier == "B6" & (distance >= 1300 & distance <=1800)))
  
summary(dplyr::filter(flights, carrier == "B6" & (distance >= 1300 & distance <=1800)))  
...
2. Cargue el dataset mpg del paquete ggplot2 y cree un diagrama de dispersión de las variables displ y hwy
?mpg
View(ggplot2::mpg)
